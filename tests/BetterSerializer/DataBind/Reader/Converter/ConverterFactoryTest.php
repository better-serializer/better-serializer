 ...
 * @author mfris
 * @package BetterSerializer\DataBind\Reader\Converter
...
class ConverterFactoryTest extends TestCase
{
    ...
    public function getTestData(): array
    {
        return [
            ...
            [new DateTimeType(DateTime::class), ToDateTimeConverter::class],
            [new DateTimeType(DateTimeImmutable::class), ToDateTimeConverter::class],
            [new DateTimeType(DateTimeImmutable::class), ToDateTimeConverter::class],
        ];
    }
