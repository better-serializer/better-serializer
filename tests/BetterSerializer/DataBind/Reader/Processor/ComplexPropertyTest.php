...
class ComplexPropertyTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $processor = new ComplexProperty($injectorMock, $complexNestedMock, $inputKey);
    ...
    public function testResolveRecursiveProcessors(): void
    {
        ...
        $processor = new ComplexProperty($injectorMock, $processorMock, $inputKey);
    ...
    public function testConstructionThrowsRuntimeException(): void
    {
        ...
        new ComplexProperty($injectorMock, $processorMock, $inputKey);
    }
