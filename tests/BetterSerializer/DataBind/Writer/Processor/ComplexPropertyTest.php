...
class ComplexPropertyTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $processor = new ComplexProperty($extractorMock, $complexNestedMock, $outputKey);
    ...
    public function testResolveRecursiveProcessors(): void
    {
        ...
        $processor = new ComplexProperty($extractorMock, $processorMock, $inputKey);
    ...
    public function testConstructionThrowsRuntimeException(): void
    {
        ...
        new ComplexProperty($extractorMock, $processorMock, $inputKey);
    }
