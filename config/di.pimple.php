...
$container['NamingStrategyTranslator'] = function ($conta) {
    return BetterSerializer\DataBind\Naming\PropertyNameTranslator\IdenticalTranslator::class;
};
